...
class MeshArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'mesh', `arn:${string}:appmesh:${string}:${string}:mesh/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}` as const
  }
}
export type { MeshArn }
...
class VirtualServiceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'virtualService', `arn:${string}:appmesh:${string}:${string}:mesh/${string}/virtualService/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}/virtualService/${this.virtualServiceName}` as const
  }
}
...
class VirtualNodeArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'virtualNode', `arn:${string}:appmesh:${string}:${string}:mesh/${string}/virtualNode/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}/virtualNode/${this.virtualNodeName}` as const
  }
}
...
class VirtualRouterArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'virtualRouter', `arn:${string}:appmesh:${string}:${string}:mesh/${string}/virtualRouter/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}/virtualRouter/${this.virtualRouterName}` as const
  }
}
...
class RouteArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'route', `arn:${string}:appmesh:${string}:${string}:mesh/${string}/virtualRouter/${string}/route/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}/virtualRouter/${this.virtualRouterName}/route/${this.routeName}` as const
  }
}
...
class VirtualGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'virtualGateway', `arn:${string}:appmesh:${string}:${string}:mesh/${string}/virtualGateway/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}/virtualGateway/${this.virtualGatewayName}` as const
  }
}
...
class GatewayRouteArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'gatewayRoute', `arn:${string}:appmesh:${string}:${string}:mesh/${string}/virtualGateway/${string}/gatewayRoute/${string}`> {
  ...
  [StringifyArnBrand]() {
    return `arn:${this.partition}:appmesh:${this.region}:${this.account}:mesh/${this.meshName}/virtualGateway/${this.virtualGatewayName}/gatewayRoute/${this.gatewayRouteName}` as const
  }
}
