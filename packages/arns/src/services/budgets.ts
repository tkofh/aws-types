...
export function budgetArn(parameters: BudgetArnParameters): BudgetArn {
  return `arn:${parameters.partition ?? 'aws'}:budgets::${parameters.account}:budget/${parameters.budgetName}`
}
...
export function budgetActionArn(parameters: BudgetActionArnParameters): BudgetActionArn {
  return `arn:${parameters.partition ?? 'aws'}:budgets::${parameters.account}:budget/${parameters.budgetName}/action/${parameters.actionId}`
}