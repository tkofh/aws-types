...
export interface ElasticIpArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly allocationId: string
}
class ElasticIpArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'elastic-ip', `arn:${string}:ec2:${string}:${string}:elastic-ip/${string}`> {
...
export function elasticIpArn<Partition extends ArnPartition = 'aws'>(parameters: ElasticIpArnParameters<Partition>) {
  return new ElasticIpArn<Partition>(parameters)
}

export interface CapacityReservationFleetArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly capacityReservationFleetId: string
}
class CapacityReservationFleetArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'capacity-reservation-fleet', `arn:${string}:ec2:${string}:${string}:capacity-reservation-fleet/${string}`> {
...
export function capacityReservationFleetArn<Partition extends ArnPartition = 'aws'>(parameters: CapacityReservationFleetArnParameters<Partition>) {
...
class CapacityReservationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'capacity-reservation', `arn:${string}:ec2:${string}:${string}:capacity-reservation/${string}`> {
...
export interface CarrierGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly carrierGatewayId: string
}
class CarrierGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'carrier-gateway', `arn:${string}:ec2:${string}:${string}:carrier-gateway/${string}`> {
...
export function carrierGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: CarrierGatewayArnParameters<Partition>) {
...
export interface ClientVpnEndpointArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly clientVpnEndpointId: string
}
class ClientVpnEndpointArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'client-vpn-endpoint', `arn:${string}:ec2:${string}:${string}:client-vpn-endpoint/${string}`> {
...
export function clientVpnEndpointArn<Partition extends ArnPartition = 'aws'>(parameters: ClientVpnEndpointArnParameters<Partition>) {
  return new ClientVpnEndpointArn<Partition>(parameters)
}

export interface CustomerGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly customerGatewayId: string
}
class CustomerGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'customer-gateway', `arn:${string}:ec2:${string}:${string}:customer-gateway/${string}`> {
...
export function customerGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: CustomerGatewayArnParameters<Partition>) {
  return new CustomerGatewayArn<Partition>(parameters)
}

export interface DedicatedHostArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly dedicatedHostId: string
}
class DedicatedHostArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'dedicated-host', `arn:${string}:ec2:${string}:${string}:dedicated-host/${string}`> {
...
export function dedicatedHostArn<Partition extends ArnPartition = 'aws'>(parameters: DedicatedHostArnParameters<Partition>) {
  return new DedicatedHostArn<Partition>(parameters)
}

export interface DhcpOptionsArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly dhcpOptionsId: string
}
class DhcpOptionsArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'dhcp-options', `arn:${string}:ec2:${string}:${string}:dhcp-options/${string}`> {
...
export function dhcpOptionsArn<Partition extends ArnPartition = 'aws'>(parameters: DhcpOptionsArnParameters<Partition>) {
  return new DhcpOptionsArn<Partition>(parameters)
}

export interface EgressOnlyInternetGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly egressOnlyInternetGatewayId: string
}
class EgressOnlyInternetGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'egress-only-internet-gateway', `arn:${string}:ec2:${string}:${string}:egress-only-internet-gateway/${string}`> {
...
export function egressOnlyInternetGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: EgressOnlyInternetGatewayArnParameters<Partition>) {
  return new EgressOnlyInternetGatewayArn<Partition>(parameters)
}

export interface ElasticGpuArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly elasticGpuId: string
}
class ElasticGpuArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'elastic-gpu', `arn:${string}:ec2:${string}:${string}:elastic-gpu/${string}`> {
...
export function elasticGpuArn<Partition extends ArnPartition = 'aws'>(parameters: ElasticGpuArnParameters<Partition>) {
  return new ElasticGpuArn<Partition>(parameters)
}

export interface ElasticInferenceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly acceleratorId: string
}
class ElasticInferenceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'elastic-inference', `arn:${string}:elastic-inference:${string}:${string}:elastic-inference-accelerator/${string}`> {
...
export function elasticInferenceArn<Partition extends ArnPartition = 'aws'>(parameters: ElasticInferenceArnParameters<Partition>) {
  return new ElasticInferenceArn<Partition>(parameters)
}

export interface ExportImageTaskArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly exportImageTaskId: string
}
class ExportImageTaskArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'export-image-task', `arn:${string}:ec2:${string}:${string}:export-image-task/${string}`> {
...
export function exportImageTaskArn<Partition extends ArnPartition = 'aws'>(parameters: ExportImageTaskArnParameters<Partition>) {
  return new ExportImageTaskArn<Partition>(parameters)
}

export interface ExportInstanceTaskArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly exportTaskId: string
}
class ExportInstanceTaskArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'export-instance-task', `arn:${string}:ec2:${string}:${string}:export-instance-task/${string}`> {
...
export function exportInstanceTaskArn<Partition extends ArnPartition = 'aws'>(parameters: ExportInstanceTaskArnParameters<Partition>) {
...
class FleetArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'fleet', `arn:${string}:ec2:${string}:${string}:fleet/${string}`> {
...
export interface FpgaImageArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly fpgaImageId: string
}
class FpgaImageArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'fpga-image', `arn:${string}:ec2:${string}:${string}:fpga-image/${string}`> {
...
export function fpgaImageArn<Partition extends ArnPartition = 'aws'>(parameters: FpgaImageArnParameters<Partition>) {
  return new FpgaImageArn<Partition>(parameters)
}

export interface HostReservationArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly hostReservationId: string
}
class HostReservationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'host-reservation', `arn:${string}:ec2:${string}:${string}:host-reservation/${string}`> {
...
export function hostReservationArn<Partition extends ArnPartition = 'aws'>(parameters: HostReservationArnParameters<Partition>) {
...
class ImageArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'image', `arn:${string}:ec2:${string}::image/${string}`> {
...
export interface ImportImageTaskArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly importImageTaskId: string
}
class ImportImageTaskArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'import-image-task', `arn:${string}:ec2:${string}:${string}:import-image-task/${string}`> {
...
export function importImageTaskArn<Partition extends ArnPartition = 'aws'>(parameters: ImportImageTaskArnParameters<Partition>) {
  return new ImportImageTaskArn<Partition>(parameters)
}

export interface ImportSnapshotTaskArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly importSnapshotTaskId: string
}
class ImportSnapshotTaskArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'import-snapshot-task', `arn:${string}:ec2:${string}:${string}:import-snapshot-task/${string}`> {
...
export function importSnapshotTaskArn<Partition extends ArnPartition = 'aws'>(parameters: ImportSnapshotTaskArnParameters<Partition>) {
...
export interface InstanceEventWindowArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly instanceEventWindowId: string
}
class InstanceEventWindowArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'instance-event-window', `arn:${string}:ec2:${string}:${string}:instance-event-window/${string}`> {
...
export function instanceEventWindowArn<Partition extends ArnPartition = 'aws'>(parameters: InstanceEventWindowArnParameters<Partition>) {
...
export interface InternetGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly internetGatewayId: string
}
class InternetGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'internet-gateway', `arn:${string}:ec2:${string}:${string}:internet-gateway/${string}`> {
...
export function internetGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: InternetGatewayArnParameters<Partition>) {
  return new InternetGatewayArn<Partition>(parameters)
}

export interface IpamExternalResourceVerificationTokenArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly account: string
  readonly ipamExternalResourceVerificationTokenId: string
}
class IpamExternalResourceVerificationTokenArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipam-external-resource-verification-token', `arn:${string}:ec2::${string}:ipam-external-resource-verification-token/${string}`> {
  readonly [ArnResourceTypeBrand] = 'ipam-external-resource-verification-token' as const
  readonly partition: Partition
  readonly account: string
  readonly ipamExternalResourceVerificationTokenId: string
  constructor(parameters: IpamExternalResourceVerificationTokenArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.account = parameters.account
    this.ipamExternalResourceVerificationTokenId = parameters.ipamExternalResourceVerificationTokenId
  }
  [StringifyArnBrand]() {
...
export function ipamExternalResourceVerificationTokenArn<Partition extends ArnPartition = 'aws'>(parameters: IpamExternalResourceVerificationTokenArnParameters<Partition>) {
...
class IpamArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipam', `arn:${string}:ec2::${string}:ipam/${string}`> {
...
export type { IpamArn }
export function ipamArn<Partition extends ArnPartition = 'aws'>(parameters: IpamArnParameters<Partition>) {
...
class IpamPoolArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipam-pool', `arn:${string}:ec2::${string}:ipam-pool/${string}`> {
...
export function ipamPoolArn<Partition extends ArnPartition = 'aws'>(parameters: IpamPoolArnParameters<Partition>) {
  return new IpamPoolArn<Partition>(parameters)
}

export interface IpamResourceDiscoveryAssociationArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly account: string
  readonly ipamResourceDiscoveryAssociationId: string
}
class IpamResourceDiscoveryAssociationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipam-resource-discovery-association', `arn:${string}:ec2::${string}:ipam-resource-discovery-association/${string}`> {
  readonly [ArnResourceTypeBrand] = 'ipam-resource-discovery-association' as const
  readonly partition: Partition
  readonly account: string
  readonly ipamResourceDiscoveryAssociationId: string
  constructor(parameters: IpamResourceDiscoveryAssociationArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.account = parameters.account
    this.ipamResourceDiscoveryAssociationId = parameters.ipamResourceDiscoveryAssociationId
  }
  [StringifyArnBrand]() {
...
export function ipamResourceDiscoveryAssociationArn<Partition extends ArnPartition = 'aws'>(parameters: IpamResourceDiscoveryAssociationArnParameters<Partition>) {
  return new IpamResourceDiscoveryAssociationArn<Partition>(parameters)
}

export interface IpamResourceDiscoveryArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly account: string
  readonly ipamResourceDiscoveryId: string
}
class IpamResourceDiscoveryArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipam-resource-discovery', `arn:${string}:ec2::${string}:ipam-resource-discovery/${string}`> {
...
export function ipamResourceDiscoveryArn<Partition extends ArnPartition = 'aws'>(parameters: IpamResourceDiscoveryArnParameters<Partition>) {
  return new IpamResourceDiscoveryArn<Partition>(parameters)
}

export interface IpamScopeArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly account: string
  readonly ipamScopeId: string
}
class IpamScopeArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipam-scope', `arn:${string}:ec2::${string}:ipam-scope/${string}`> {
...
export function ipamScopeArn<Partition extends ArnPartition = 'aws'>(parameters: IpamScopeArnParameters<Partition>) {
...
class CoipPoolArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'coip-pool', `arn:${string}:ec2:${string}:${string}:coip-pool/${string}`> {
...
export function coipPoolArn<Partition extends ArnPartition = 'aws'>(parameters: CoipPoolArnParameters<Partition>) {
  return new CoipPoolArn<Partition>(parameters)
}

export interface Ipv4poolEc2ArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly ipv4PoolEc2Id: string
}
class Ipv4poolEc2Arn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipv4pool-ec2', `arn:${string}:ec2:${string}:${string}:ipv4pool-ec2/${string}`> {
...
export function ipv4poolEc2Arn<Partition extends ArnPartition = 'aws'>(parameters: Ipv4poolEc2ArnParameters<Partition>) {
  return new Ipv4poolEc2Arn<Partition>(parameters)
}

export interface Ipv6poolEc2ArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly ipv6PoolEc2Id: string
}
class Ipv6poolEc2Arn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ipv6pool-ec2', `arn:${string}:ec2:${string}:${string}:ipv6pool-ec2/${string}`> {
...
export function ipv6poolEc2Arn<Partition extends ArnPartition = 'aws'>(parameters: Ipv6poolEc2ArnParameters<Partition>) {
...
class KeyPairArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'key-pair', `arn:${string}:ec2:${string}:${string}:key-pair/${string}`> {
...
export interface LaunchTemplateArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly launchTemplateId: string
}
class LaunchTemplateArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'launch-template', `arn:${string}:ec2:${string}:${string}:launch-template/${string}`> {
...
export function launchTemplateArn<Partition extends ArnPartition = 'aws'>(parameters: LaunchTemplateArnParameters<Partition>) {
...
export interface LocalGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayId: string
}
class LocalGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'local-gateway', `arn:${string}:ec2:${string}:${string}:local-gateway/${string}`> {
...
export function localGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: LocalGatewayArnParameters<Partition>) {
  return new LocalGatewayArn<Partition>(parameters)
}

export interface LocalGatewayRouteTableVirtualInterfaceGroupAssociationArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayRouteTableVirtualInterfaceGroupAssociationId: string
}
class LocalGatewayRouteTableVirtualInterfaceGroupAssociationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'local-gateway-route-table-virtual-interface-group-association', `arn:${string}:ec2:${string}:${string}:local-gateway-route-table-virtual-interface-group-association/${string}`> {
  readonly [ArnResourceTypeBrand] = 'local-gateway-route-table-virtual-interface-group-association' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayRouteTableVirtualInterfaceGroupAssociationId: string
  constructor(parameters: LocalGatewayRouteTableVirtualInterfaceGroupAssociationArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.localGatewayRouteTableVirtualInterfaceGroupAssociationId = parameters.localGatewayRouteTableVirtualInterfaceGroupAssociationId
  }
  [StringifyArnBrand]() {
...
export function localGatewayRouteTableVirtualInterfaceGroupAssociationArn<Partition extends ArnPartition = 'aws'>(parameters: LocalGatewayRouteTableVirtualInterfaceGroupAssociationArnParameters<Partition>) {
  return new LocalGatewayRouteTableVirtualInterfaceGroupAssociationArn<Partition>(parameters)
}

export interface LocalGatewayRouteTableVpcAssociationArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayRouteTableVpcAssociationId: string
}
class LocalGatewayRouteTableVpcAssociationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'local-gateway-route-table-vpc-association', `arn:${string}:ec2:${string}:${string}:local-gateway-route-table-vpc-association/${string}`> {
  readonly [ArnResourceTypeBrand] = 'local-gateway-route-table-vpc-association' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayRouteTableVpcAssociationId: string
  constructor(parameters: LocalGatewayRouteTableVpcAssociationArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.localGatewayRouteTableVpcAssociationId = parameters.localGatewayRouteTableVpcAssociationId
  }
  [StringifyArnBrand]() {
...
export function localGatewayRouteTableVpcAssociationArn<Partition extends ArnPartition = 'aws'>(parameters: LocalGatewayRouteTableVpcAssociationArnParameters<Partition>) {
  return new LocalGatewayRouteTableVpcAssociationArn<Partition>(parameters)
}

export interface LocalGatewayRouteTableArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayRoutetableId: string
}
class LocalGatewayRouteTableArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'local-gateway-route-table', `arn:${string}:ec2:${string}:${string}:local-gateway-route-table/${string}`> {
...
export function localGatewayRouteTableArn<Partition extends ArnPartition = 'aws'>(parameters: LocalGatewayRouteTableArnParameters<Partition>) {
  return new LocalGatewayRouteTableArn<Partition>(parameters)
}

export interface LocalGatewayVirtualInterfaceGroupArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayVirtualInterfaceGroupId: string
}
class LocalGatewayVirtualInterfaceGroupArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'local-gateway-virtual-interface-group', `arn:${string}:ec2:${string}:${string}:local-gateway-virtual-interface-group/${string}`> {
  readonly [ArnResourceTypeBrand] = 'local-gateway-virtual-interface-group' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayVirtualInterfaceGroupId: string
  constructor(parameters: LocalGatewayVirtualInterfaceGroupArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.localGatewayVirtualInterfaceGroupId = parameters.localGatewayVirtualInterfaceGroupId
  }
  [StringifyArnBrand]() {
...
export function localGatewayVirtualInterfaceGroupArn<Partition extends ArnPartition = 'aws'>(parameters: LocalGatewayVirtualInterfaceGroupArnParameters<Partition>) {
  return new LocalGatewayVirtualInterfaceGroupArn<Partition>(parameters)
}

export interface LocalGatewayVirtualInterfaceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayVirtualInterfaceId: string
}
class LocalGatewayVirtualInterfaceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'local-gateway-virtual-interface', `arn:${string}:ec2:${string}:${string}:local-gateway-virtual-interface/${string}`> {
  readonly [ArnResourceTypeBrand] = 'local-gateway-virtual-interface' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly localGatewayVirtualInterfaceId: string
  constructor(parameters: LocalGatewayVirtualInterfaceArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.localGatewayVirtualInterfaceId = parameters.localGatewayVirtualInterfaceId
  }
  [StringifyArnBrand]() {
...
export function localGatewayVirtualInterfaceArn<Partition extends ArnPartition = 'aws'>(parameters: LocalGatewayVirtualInterfaceArnParameters<Partition>) {
  return new LocalGatewayVirtualInterfaceArn<Partition>(parameters)
}

export interface NatgatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly natGatewayId: string
}
class NatgatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'natgateway', `arn:${string}:ec2:${string}:${string}:natgateway/${string}`> {
...
export function natgatewayArn<Partition extends ArnPartition = 'aws'>(parameters: NatgatewayArnParameters<Partition>) {
  return new NatgatewayArn<Partition>(parameters)
}

export interface NetworkAclArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly naclId: string
}
class NetworkAclArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'network-acl', `arn:${string}:ec2:${string}:${string}:network-acl/${string}`> {
...
export function networkAclArn<Partition extends ArnPartition = 'aws'>(parameters: NetworkAclArnParameters<Partition>) {
  return new NetworkAclArn<Partition>(parameters)
}

export interface NetworkInsightsAccessScopeAnalysisArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly networkInsightsAccessScopeAnalysisId: string
}
class NetworkInsightsAccessScopeAnalysisArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'network-insights-access-scope-analysis', `arn:${string}:ec2:${string}:${string}:network-insights-access-scope-analysis/${string}`> {
  readonly [ArnResourceTypeBrand] = 'network-insights-access-scope-analysis' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly networkInsightsAccessScopeAnalysisId: string
  constructor(parameters: NetworkInsightsAccessScopeAnalysisArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.networkInsightsAccessScopeAnalysisId = parameters.networkInsightsAccessScopeAnalysisId
  }
  [StringifyArnBrand]() {
...
export function networkInsightsAccessScopeAnalysisArn<Partition extends ArnPartition = 'aws'>(parameters: NetworkInsightsAccessScopeAnalysisArnParameters<Partition>) {
  return new NetworkInsightsAccessScopeAnalysisArn<Partition>(parameters)
}

export interface NetworkInsightsAccessScopeArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly networkInsightsAccessScopeId: string
}
class NetworkInsightsAccessScopeArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'network-insights-access-scope', `arn:${string}:ec2:${string}:${string}:network-insights-access-scope/${string}`> {
...
export function networkInsightsAccessScopeArn<Partition extends ArnPartition = 'aws'>(parameters: NetworkInsightsAccessScopeArnParameters<Partition>) {
  return new NetworkInsightsAccessScopeArn<Partition>(parameters)
}

export interface NetworkInsightsAnalysisArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly networkInsightsAnalysisId: string
}
class NetworkInsightsAnalysisArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'network-insights-analysis', `arn:${string}:ec2:${string}:${string}:network-insights-analysis/${string}`> {
...
export function networkInsightsAnalysisArn<Partition extends ArnPartition = 'aws'>(parameters: NetworkInsightsAnalysisArnParameters<Partition>) {
  return new NetworkInsightsAnalysisArn<Partition>(parameters)
}

export interface NetworkInsightsPathArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly networkInsightsPathId: string
}
class NetworkInsightsPathArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'network-insights-path', `arn:${string}:ec2:${string}:${string}:network-insights-path/${string}`> {
...
export function networkInsightsPathArn<Partition extends ArnPartition = 'aws'>(parameters: NetworkInsightsPathArnParameters<Partition>) {
  return new NetworkInsightsPathArn<Partition>(parameters)
}

export interface NetworkInterfaceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly networkInterfaceId: string
}
class NetworkInterfaceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'network-interface', `arn:${string}:ec2:${string}:${string}:network-interface/${string}`> {
...
export function networkInterfaceArn<Partition extends ArnPartition = 'aws'>(parameters: NetworkInterfaceArnParameters<Partition>) {
  return new NetworkInterfaceArn<Partition>(parameters)
}

export interface PlacementGroupArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly placementGroupName: string
}
class PlacementGroupArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'placement-group', `arn:${string}:ec2:${string}:${string}:placement-group/${string}`> {
...
export function placementGroupArn<Partition extends ArnPartition = 'aws'>(parameters: PlacementGroupArnParameters<Partition>) {
  return new PlacementGroupArn<Partition>(parameters)
}

export interface PrefixListArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly prefixListId: string
}
class PrefixListArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'prefix-list', `arn:${string}:ec2:${string}:${string}:prefix-list/${string}`> {
...
export function prefixListArn<Partition extends ArnPartition = 'aws'>(parameters: PrefixListArnParameters<Partition>) {
  return new PrefixListArn<Partition>(parameters)
}

export interface ReplaceRootVolumeTaskArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly replaceRootVolumeTaskId: string
}
class ReplaceRootVolumeTaskArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'replace-root-volume-task', `arn:${string}:ec2:${string}:${string}:replace-root-volume-task/${string}`> {
...
export function replaceRootVolumeTaskArn<Partition extends ArnPartition = 'aws'>(parameters: ReplaceRootVolumeTaskArnParameters<Partition>) {
  return new ReplaceRootVolumeTaskArn<Partition>(parameters)
}

export interface ReservedInstancesArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly reservationId: string
}
class ReservedInstancesArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'reserved-instances', `arn:${string}:ec2:${string}:${string}:reserved-instances/${string}`> {
...
export function reservedInstancesArn<Partition extends ArnPartition = 'aws'>(parameters: ReservedInstancesArnParameters<Partition>) {
...
export interface RouteTableArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly routeTableId: string
}
class RouteTableArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'route-table', `arn:${string}:ec2:${string}:${string}:route-table/${string}`> {
...
export function routeTableArn<Partition extends ArnPartition = 'aws'>(parameters: RouteTableArnParameters<Partition>) {
...
class SecurityGroupArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'security-group', `arn:${string}:ec2:${string}:${string}:security-group/${string}`> {
...
export interface SecurityGroupRuleArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly securityGroupRuleId: string
}
class SecurityGroupRuleArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'security-group-rule', `arn:${string}:ec2:${string}:${string}:security-group-rule/${string}`> {
...
export function securityGroupRuleArn<Partition extends ArnPartition = 'aws'>(parameters: SecurityGroupRuleArnParameters<Partition>) {
...
export interface SpotFleetRequestArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly spotFleetRequestId: string
}
class SpotFleetRequestArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'spot-fleet-request', `arn:${string}:ec2:${string}:${string}:spot-fleet-request/${string}`> {
...
export function spotFleetRequestArn<Partition extends ArnPartition = 'aws'>(parameters: SpotFleetRequestArnParameters<Partition>) {
  return new SpotFleetRequestArn<Partition>(parameters)
}

export interface SpotInstancesRequestArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly spotInstanceRequestId: string
}
class SpotInstancesRequestArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'spot-instances-request', `arn:${string}:ec2:${string}:${string}:spot-instances-request/${string}`> {
...
export function spotInstancesRequestArn<Partition extends ArnPartition = 'aws'>(parameters: SpotInstancesRequestArnParameters<Partition>) {
  return new SpotInstancesRequestArn<Partition>(parameters)
}

export interface SubnetCidrReservationArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly subnetCidrReservationId: string
}
class SubnetCidrReservationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'subnet-cidr-reservation', `arn:${string}:ec2:${string}:${string}:subnet-cidr-reservation/${string}`> {
...
export function subnetCidrReservationArn<Partition extends ArnPartition = 'aws'>(parameters: SubnetCidrReservationArnParameters<Partition>) {
...
class SubnetArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'subnet', `arn:${string}:ec2:${string}:${string}:subnet/${string}`> {
...
export function subnetArn<Partition extends ArnPartition = 'aws'>(parameters: SubnetArnParameters<Partition>) {
  return new SubnetArn<Partition>(parameters)
}

export interface TrafficMirrorFilterArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly trafficMirrorFilterId: string
}
class TrafficMirrorFilterArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'traffic-mirror-filter', `arn:${string}:ec2:${string}:${string}:traffic-mirror-filter/${string}`> {
...
export function trafficMirrorFilterArn<Partition extends ArnPartition = 'aws'>(parameters: TrafficMirrorFilterArnParameters<Partition>) {
  return new TrafficMirrorFilterArn<Partition>(parameters)
}

export interface TrafficMirrorFilterRuleArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly trafficMirrorFilterRuleId: string
}
class TrafficMirrorFilterRuleArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'traffic-mirror-filter-rule', `arn:${string}:ec2:${string}:${string}:traffic-mirror-filter-rule/${string}`> {
...
export function trafficMirrorFilterRuleArn<Partition extends ArnPartition = 'aws'>(parameters: TrafficMirrorFilterRuleArnParameters<Partition>) {
  return new TrafficMirrorFilterRuleArn<Partition>(parameters)
}

export interface TrafficMirrorSessionArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly trafficMirrorSessionId: string
}
class TrafficMirrorSessionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'traffic-mirror-session', `arn:${string}:ec2:${string}:${string}:traffic-mirror-session/${string}`> {
...
export function trafficMirrorSessionArn<Partition extends ArnPartition = 'aws'>(parameters: TrafficMirrorSessionArnParameters<Partition>) {
  return new TrafficMirrorSessionArn<Partition>(parameters)
}

export interface TrafficMirrorTargetArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly trafficMirrorTargetId: string
}
class TrafficMirrorTargetArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'traffic-mirror-target', `arn:${string}:ec2:${string}:${string}:traffic-mirror-target/${string}`> {
...
export function trafficMirrorTargetArn<Partition extends ArnPartition = 'aws'>(parameters: TrafficMirrorTargetArnParameters<Partition>) {
  return new TrafficMirrorTargetArn<Partition>(parameters)
}

export interface TransitGatewayAttachmentArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayAttachmentId: string
}
class TransitGatewayAttachmentArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway-attachment', `arn:${string}:ec2:${string}:${string}:transit-gateway-attachment/${string}`> {
...
export function transitGatewayAttachmentArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayAttachmentArnParameters<Partition>) {
  return new TransitGatewayAttachmentArn<Partition>(parameters)
}

export interface TransitGatewayConnectPeerArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayConnectPeerId: string
}
class TransitGatewayConnectPeerArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway-connect-peer', `arn:${string}:ec2:${string}:${string}:transit-gateway-connect-peer/${string}`> {
...
export function transitGatewayConnectPeerArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayConnectPeerArnParameters<Partition>) {
  return new TransitGatewayConnectPeerArn<Partition>(parameters)
}

export interface TransitGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayId: string
}
class TransitGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway', `arn:${string}:ec2:${string}:${string}:transit-gateway/${string}`> {
...
export function transitGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayArnParameters<Partition>) {
  return new TransitGatewayArn<Partition>(parameters)
}

export interface TransitGatewayMulticastDomainArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayMulticastDomainId: string
}
class TransitGatewayMulticastDomainArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway-multicast-domain', `arn:${string}:ec2:${string}:${string}:transit-gateway-multicast-domain/${string}`> {
  readonly [ArnResourceTypeBrand] = 'transit-gateway-multicast-domain' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayMulticastDomainId: string
  constructor(parameters: TransitGatewayMulticastDomainArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.transitGatewayMulticastDomainId = parameters.transitGatewayMulticastDomainId
  }
  [StringifyArnBrand]() {
...
export function transitGatewayMulticastDomainArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayMulticastDomainArnParameters<Partition>) {
  return new TransitGatewayMulticastDomainArn<Partition>(parameters)
}

export interface TransitGatewayPolicyTableArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayPolicyTableId: string
}
class TransitGatewayPolicyTableArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway-policy-table', `arn:${string}:ec2:${string}:${string}:transit-gateway-policy-table/${string}`> {
...
export function transitGatewayPolicyTableArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayPolicyTableArnParameters<Partition>) {
  return new TransitGatewayPolicyTableArn<Partition>(parameters)
}

export interface TransitGatewayRouteTableAnnouncementArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayRouteTableAnnouncementId: string
}
class TransitGatewayRouteTableAnnouncementArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway-route-table-announcement', `arn:${string}:ec2:${string}:${string}:transit-gateway-route-table-announcement/${string}`> {
  readonly [ArnResourceTypeBrand] = 'transit-gateway-route-table-announcement' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayRouteTableAnnouncementId: string
  constructor(parameters: TransitGatewayRouteTableAnnouncementArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.transitGatewayRouteTableAnnouncementId = parameters.transitGatewayRouteTableAnnouncementId
  }
  [StringifyArnBrand]() {
...
export function transitGatewayRouteTableAnnouncementArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayRouteTableAnnouncementArnParameters<Partition>) {
  return new TransitGatewayRouteTableAnnouncementArn<Partition>(parameters)
}

export interface TransitGatewayRouteTableArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly transitGatewayRouteTableId: string
}
class TransitGatewayRouteTableArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'transit-gateway-route-table', `arn:${string}:ec2:${string}:${string}:transit-gateway-route-table/${string}`> {
...
export function transitGatewayRouteTableArn<Partition extends ArnPartition = 'aws'>(parameters: TransitGatewayRouteTableArnParameters<Partition>) {
  return new TransitGatewayRouteTableArn<Partition>(parameters)
}

export interface VerifiedAccessEndpointArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly verifiedAccessEndpointId: string
}
class VerifiedAccessEndpointArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'verified-access-endpoint', `arn:${string}:ec2:${string}:${string}:verified-access-endpoint/${string}`> {
...
export function verifiedAccessEndpointArn<Partition extends ArnPartition = 'aws'>(parameters: VerifiedAccessEndpointArnParameters<Partition>) {
  return new VerifiedAccessEndpointArn<Partition>(parameters)
}

export interface VerifiedAccessGroupArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly verifiedAccessGroupId: string
}
class VerifiedAccessGroupArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'verified-access-group', `arn:${string}:ec2:${string}:${string}:verified-access-group/${string}`> {
...
export function verifiedAccessGroupArn<Partition extends ArnPartition = 'aws'>(parameters: VerifiedAccessGroupArnParameters<Partition>) {
  return new VerifiedAccessGroupArn<Partition>(parameters)
}

export interface VerifiedAccessInstanceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly verifiedAccessInstanceId: string
}
class VerifiedAccessInstanceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'verified-access-instance', `arn:${string}:ec2:${string}:${string}:verified-access-instance/${string}`> {
...
export function verifiedAccessInstanceArn<Partition extends ArnPartition = 'aws'>(parameters: VerifiedAccessInstanceArnParameters<Partition>) {
  return new VerifiedAccessInstanceArn<Partition>(parameters)
}

export interface VerifiedAccessPolicyArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly verifiedAccessPolicyId: string
}
class VerifiedAccessPolicyArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'verified-access-policy', `arn:${string}:ec2:${string}:${string}:verified-access-policy/${string}`> {
...
export function verifiedAccessPolicyArn<Partition extends ArnPartition = 'aws'>(parameters: VerifiedAccessPolicyArnParameters<Partition>) {
  return new VerifiedAccessPolicyArn<Partition>(parameters)
}

export interface VerifiedAccessTrustProviderArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly verifiedAccessTrustProviderId: string
}
class VerifiedAccessTrustProviderArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'verified-access-trust-provider', `arn:${string}:ec2:${string}:${string}:verified-access-trust-provider/${string}`> {
  ...
  constructor(parameters: VerifiedAccessTrustProviderArnParameters<Partition>) {
    ...
    this.region = parameters.region
    this.account = parameters.account
    this.verifiedAccessTrustProviderId = parameters.verifiedAccessTrustProviderId
  }
  [StringifyArnBrand]() {
...
export function verifiedAccessTrustProviderArn<Partition extends ArnPartition = 'aws'>(parameters: VerifiedAccessTrustProviderArnParameters<Partition>) {
...
class VolumeArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'volume', `arn:${string}:ec2:${string}:${string}:volume/${string}`> {
...
export interface VpcEndpointConnectionArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcEndpointConnectionId: string
}
class VpcEndpointConnectionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpc-endpoint-connection', `arn:${string}:ec2:${string}:${string}:vpc-endpoint-connection/${string}`> {
...
export function vpcEndpointConnectionArn<Partition extends ArnPartition = 'aws'>(parameters: VpcEndpointConnectionArnParameters<Partition>) {
  return new VpcEndpointConnectionArn<Partition>(parameters)
}

export interface VpcEndpointArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcEndpointId: string
}
class VpcEndpointArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpc-endpoint', `arn:${string}:ec2:${string}:${string}:vpc-endpoint/${string}`> {
...
export function vpcEndpointArn<Partition extends ArnPartition = 'aws'>(parameters: VpcEndpointArnParameters<Partition>) {
  return new VpcEndpointArn<Partition>(parameters)
}

export interface VpcEndpointServiceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcEndpointServiceId: string
}
class VpcEndpointServiceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpc-endpoint-service', `arn:${string}:ec2:${string}:${string}:vpc-endpoint-service/${string}`> {
...
export function vpcEndpointServiceArn<Partition extends ArnPartition = 'aws'>(parameters: VpcEndpointServiceArnParameters<Partition>) {
  return new VpcEndpointServiceArn<Partition>(parameters)
}

export interface VpcEndpointServicePermissionArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcEndpointServicePermissionId: string
}
class VpcEndpointServicePermissionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpc-endpoint-service-permission', `arn:${string}:ec2:${string}:${string}:vpc-endpoint-service-permission/${string}`> {
  readonly [ArnResourceTypeBrand] = 'vpc-endpoint-service-permission' as const
  readonly partition: Partition
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcEndpointServicePermissionId: string
  constructor(parameters: VpcEndpointServicePermissionArnParameters<Partition>) {
    super()
    this.partition = (parameters.partition ?? 'aws') as Partition
    this.region = parameters.region
    this.account = parameters.account
    this.vpcEndpointServicePermissionId = parameters.vpcEndpointServicePermissionId
  }
  [StringifyArnBrand]() {
...
export function vpcEndpointServicePermissionArn<Partition extends ArnPartition = 'aws'>(parameters: VpcEndpointServicePermissionArnParameters<Partition>) {
  return new VpcEndpointServicePermissionArn<Partition>(parameters)
}

export interface VpcFlowLogArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcFlowLogId: string
}
class VpcFlowLogArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpc-flow-log', `arn:${string}:ec2:${string}:${string}:vpc-flow-log/${string}`> {
...
export function vpcFlowLogArn<Partition extends ArnPartition = 'aws'>(parameters: VpcFlowLogArnParameters<Partition>) {
...
export interface VpcPeeringConnectionArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpcPeeringConnectionId: string
}
class VpcPeeringConnectionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpc-peering-connection', `arn:${string}:ec2:${string}:${string}:vpc-peering-connection/${string}`> {
...
export function vpcPeeringConnectionArn<Partition extends ArnPartition = 'aws'>(parameters: VpcPeeringConnectionArnParameters<Partition>) {
  return new VpcPeeringConnectionArn<Partition>(parameters)
}

export interface VpnConnectionDeviceTypeArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpnConnectionDeviceTypeId: string
}
class VpnConnectionDeviceTypeArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpn-connection-device-type', `arn:${string}:ec2:${string}:${string}:vpn-connection-device-type/${string}`> {
...
export function vpnConnectionDeviceTypeArn<Partition extends ArnPartition = 'aws'>(parameters: VpnConnectionDeviceTypeArnParameters<Partition>) {
  return new VpnConnectionDeviceTypeArn<Partition>(parameters)
}

export interface VpnConnectionArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpnConnectionId: string
}
class VpnConnectionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpn-connection', `arn:${string}:ec2:${string}:${string}:vpn-connection/${string}`> {
...
export function vpnConnectionArn<Partition extends ArnPartition = 'aws'>(parameters: VpnConnectionArnParameters<Partition>) {
  return new VpnConnectionArn<Partition>(parameters)
}

export interface VpnGatewayArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly vpnGatewayId: string
}
class VpnGatewayArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpn-gateway', `arn:${string}:ec2:${string}:${string}:vpn-gateway/${string}`> {
...
export function vpnGatewayArn<Partition extends ArnPartition = 'aws'>(parameters: VpnGatewayArnParameters<Partition>) {
