...
export interface AnnotationImportJobArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly annotationImportJobId: string
}
class AnnotationImportJobArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'AnnotationImportJob', `arn:${string}:omics:${string}:${string}:annotationImportJob/${string}`> {
...
export function annotationImportJobArn<Partition extends ArnPartition = 'aws'>(parameters: AnnotationImportJobArnParameters<Partition>) {
  return new AnnotationImportJobArn<Partition>(parameters)
}

export interface AnnotationStoreArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly annotationStoreId: string
}
class AnnotationStoreArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'AnnotationStore', `arn:${string}:omics:${string}:${string}:annotationStore/${string}`> {
...
export function annotationStoreArn<Partition extends ArnPartition = 'aws'>(parameters: AnnotationStoreArnParameters<Partition>) {
  return new AnnotationStoreArn<Partition>(parameters)
}

export interface AnnotationStoreVersionArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
...
class AnnotationStoreVersionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'AnnotationStoreVersion', `arn:${string}:omics:${string}:${string}:annotationStore/${string}/version/${string}`> {
...
export function annotationStoreVersionArn<Partition extends ArnPartition = 'aws'>(parameters: AnnotationStoreVersionArnParameters<Partition>) {
...
class ReadSetArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'readSet', `arn:${string}:omics:${string}:${string}:sequenceStore/${string}/readSet/${string}`> {
...
export function readSetArn<Partition extends ArnPartition = 'aws'>(parameters: ReadSetArnParameters<Partition>) {
  return new ReadSetArn<Partition>(parameters)
}

export interface ReferenceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
...
class ReferenceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'reference', `arn:${string}:omics:${string}:${string}:referenceStore/${string}/reference/${string}`> {
...
export function referenceArn<Partition extends ArnPartition = 'aws'>(parameters: ReferenceArnParameters<Partition>) {
  return new ReferenceArn<Partition>(parameters)
}

export interface ReferenceStoreArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly referenceStoreId: string
}
class ReferenceStoreArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'referenceStore', `arn:${string}:omics:${string}:${string}:referenceStore/${string}`> {
...
export function referenceStoreArn<Partition extends ArnPartition = 'aws'>(parameters: ReferenceStoreArnParameters<Partition>) {
...
class RunArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'run', `arn:${string}:omics:${string}:${string}:run/${string}`> {
...
export type { RunArn }
export function runArn<Partition extends ArnPartition = 'aws'>(parameters: RunArnParameters<Partition>) {
...
class RunGroupArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'runGroup', `arn:${string}:omics:${string}:${string}:runGroup/${string}`> {
...
export function runGroupArn<Partition extends ArnPartition = 'aws'>(parameters: RunGroupArnParameters<Partition>) {
  return new RunGroupArn<Partition>(parameters)
}

export interface SequenceStoreArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly sequenceStoreId: string
}
class SequenceStoreArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'sequenceStore', `arn:${string}:omics:${string}:${string}:sequenceStore/${string}`> {
...
export function sequenceStoreArn<Partition extends ArnPartition = 'aws'>(parameters: SequenceStoreArnParameters<Partition>) {
  return new SequenceStoreArn<Partition>(parameters)
}

export interface TaggingResourceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly tagKey: string
}
class TaggingResourceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'TaggingResource', `arn:${string}:omics:${string}:${string}:tag/${string}`> {
...
export function taggingResourceArn<Partition extends ArnPartition = 'aws'>(parameters: TaggingResourceArnParameters<Partition>) {
  return new TaggingResourceArn<Partition>(parameters)
}

export interface TaskResourceArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly id: string
}
class TaskResourceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'TaskResource', `arn:${string}:omics:${string}:${string}:task/${string}`> {
...
export function taskResourceArn<Partition extends ArnPartition = 'aws'>(parameters: TaskResourceArnParameters<Partition>) {
  return new TaskResourceArn<Partition>(parameters)
}

export interface VariantImportJobArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly variantImportJobId: string
}
class VariantImportJobArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'VariantImportJob', `arn:${string}:omics:${string}:${string}:variantImportJob/${string}`> {
...
export function variantImportJobArn<Partition extends ArnPartition = 'aws'>(parameters: VariantImportJobArnParameters<Partition>) {
  return new VariantImportJobArn<Partition>(parameters)
}

export interface VariantStoreArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly variantStoreId: string
}
class VariantStoreArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'VariantStore', `arn:${string}:omics:${string}:${string}:variantStore/${string}`> {
...
export function variantStoreArn<Partition extends ArnPartition = 'aws'>(parameters: VariantStoreArnParameters<Partition>) {
...
class WorkflowArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'workflow', `arn:${string}:omics:${string}:${string}:workflow/${string}`> {
