...
export function collectionArn(parameters: CollectionArnParameters): CollectionArn {
  return `arn:${parameters.partition ?? 'aws'}:aoss:${parameters.region}:${parameters.account}:collection/${parameters.collectionId}`
}
...
export function dashboardsArn(parameters: DashboardsArnParameters): DashboardsArn {
  return `arn:${parameters.partition ?? 'aws'}:aoss:${parameters.region}:${parameters.account}:dashboards/default`
}