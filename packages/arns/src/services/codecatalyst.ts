...
export function connectionsArn(parameters: ConnectionsArnParameters): ConnectionsArn {
  return `arn:${parameters.partition ?? 'aws'}:codecatalyst:${parameters.region}:${parameters.account}:/connections/${parameters.connectionId}`
}
...
export function identityCenterApplicationsArn(parameters: IdentityCenterApplicationsArnParameters): IdentityCenterApplicationsArn {
  return `arn:${parameters.partition ?? 'aws'}:codecatalyst:${parameters.region}:${parameters.account}:/identity-center-applications/${parameters.identityCenterApplicationId}`
}
...
export function spaceArn(parameters: SpaceArnParameters): SpaceArn {
  return `arn:${parameters.partition ?? 'aws'}:codecatalyst:::space/${parameters.spaceId}`
}
...
export function projectArn(parameters: ProjectArnParameters): ProjectArn {
  return `arn:${parameters.partition ?? 'aws'}:codecatalyst:::space/${parameters.spaceId}/project/${parameters.projectId}`
}