...
export function configurationSetArn(parameters: ConfigurationSetArnParameters): ConfigurationSetArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:configuration-set/${parameters.configurationSetName}`
}
...
export function dedicatedIpPoolArn(parameters: DedicatedIpPoolArnParameters): DedicatedIpPoolArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:dedicated-ip-pool/${parameters.dedicatedIpPool}`
}
...
export function deliverabilityTestReportArn(parameters: DeliverabilityTestReportArnParameters): DeliverabilityTestReportArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:deliverability-test-report/${parameters.reportId}`
}
...
export function identityArn(parameters: IdentityArnParameters): IdentityArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:identity/${parameters.identityName}`
}
...
export function addonInstanceArn(parameters: AddonInstanceArnParameters): AddonInstanceArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:addon-instance/${parameters.addonInstanceId}`
}
...
export function addonSubscriptionArn(parameters: AddonSubscriptionArnParameters): AddonSubscriptionArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:addon-subscription/${parameters.addonSubscriptionId}`
}
...
export function mailmanagerArchiveArn(parameters: MailmanagerArchiveArnParameters): MailmanagerArchiveArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:mailmanager-archive/${parameters.archiveId}`
}
...
export function mailmanagerIngressPointArn(parameters: MailmanagerIngressPointArnParameters): MailmanagerIngressPointArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:mailmanager-ingress-point/${parameters.ingressPointId}`
}
...
export function mailmanagerSmtpRelayArn(parameters: MailmanagerSmtpRelayArnParameters): MailmanagerSmtpRelayArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:mailmanager-smtp-relay/${parameters.relayId}`
}
...
export function mailmanagerRuleSetArn(parameters: MailmanagerRuleSetArnParameters): MailmanagerRuleSetArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:mailmanager-rule-set/${parameters.ruleSetId}`
}
...
export function mailmanagerTrafficPolicyArn(parameters: MailmanagerTrafficPolicyArnParameters): MailmanagerTrafficPolicyArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:mailmanager-traffic-policy/${parameters.trafficPolicyId}`
}
...
export function customVerificationEmailTemplateArn(parameters: CustomVerificationEmailTemplateArnParameters): CustomVerificationEmailTemplateArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:custom-verification-email-template/${parameters.templateName}`
}
...
export function templateArn(parameters: TemplateArnParameters): TemplateArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:template/${parameters.templateName}`
}
...
export function contactListArn(parameters: ContactListArnParameters): ContactListArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:contact-list/${parameters.contactListName}`
}
...
export function exportJobArn(parameters: ExportJobArnParameters): ExportJobArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:export-job/${parameters.exportJobId}`
}
...
export function importJobArn(parameters: ImportJobArnParameters): ImportJobArn {
  return `arn:${parameters.partition ?? 'aws'}:ses:${parameters.region}:${parameters.account}:import-job/${parameters.importJobId}`
}