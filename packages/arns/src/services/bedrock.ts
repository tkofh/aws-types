...
export function foundationModelArn(parameters: FoundationModelArnParameters): FoundationModelArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}::foundation-model/${parameters.resourceId}`
}
...
export function inferenceProfileArn(parameters: InferenceProfileArnParameters): InferenceProfileArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:inference-profile/${parameters.resourceId}`
}
...
export function customModelArn(parameters: CustomModelArnParameters): CustomModelArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:custom-model/${parameters.resourceId}`
}
...
export function provisionedModelArn(parameters: ProvisionedModelArnParameters): ProvisionedModelArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:provisioned-model/${parameters.resourceId}`
}
...
export function modelCustomizationJobArn(parameters: ModelCustomizationJobArnParameters): ModelCustomizationJobArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:model-customization-job/${parameters.resourceId}`
}
...
export function agentArn(parameters: AgentArnParameters): AgentArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:agent/${parameters.agentId}`
}
...
export function agentAliasArn(parameters: AgentAliasArnParameters): AgentAliasArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:agent-alias/${parameters.agentId}/${parameters.agentAliasId}`
}
...
export function knowledgeBaseArn(parameters: KnowledgeBaseArnParameters): KnowledgeBaseArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:knowledge-base/${parameters.knowledgeBaseId}`
}
...
export function modelEvaluationJobArn(parameters: ModelEvaluationJobArnParameters): ModelEvaluationJobArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:model-evaluation-job/${parameters.resourceId}`
}
...
export function evaluationJobArn(parameters: EvaluationJobArnParameters): EvaluationJobArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:evaluation-job/${parameters.resourceId}`
}
...
export function modelInvocationJobArn(parameters: ModelInvocationJobArnParameters): ModelInvocationJobArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:model-invocation-job/${parameters.jobIdentifier}`
}
...
export function guardrailArn(parameters: GuardrailArnParameters): GuardrailArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:guardrail/${parameters.guardrailId}`
}
...
export function flowArn(parameters: FlowArnParameters): FlowArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:flow/${parameters.flowId}`
}
...
export function flowAliasArn(parameters: FlowAliasArnParameters): FlowAliasArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:flow/${parameters.flowId}/alias/${parameters.flowAliasId}`
}
...
export function modelCopyJobArn(parameters: ModelCopyJobArnParameters): ModelCopyJobArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:model-copy-job/${parameters.resourceId}`
}
...
export function promptArn(parameters: PromptArnParameters): PromptArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:prompt/${parameters.promptId}`
}
...
export function promptVersionArn(parameters: PromptVersionArnParameters): PromptVersionArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:prompt/${parameters.promptId}:${parameters.promptVersion}`
}
...
export function modelImportJobArn(parameters: ModelImportJobArnParameters): ModelImportJobArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:model-import-job/${parameters.resourceId}`
}
...
export function importedModelArn(parameters: ImportedModelArnParameters): ImportedModelArn {
  return `arn:${parameters.partition ?? 'aws'}:bedrock:${parameters.region}:${parameters.account}:imported-model/${parameters.resourceId}`
}