...
export function fleetArn(parameters: FleetArnParameters): FleetArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:fleet/${parameters.fleetName}`
}
...
export function imageArn(parameters: ImageArnParameters): ImageArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:image/${parameters.imageName}`
}
...
export function imageBuilderArn(parameters: ImageBuilderArnParameters): ImageBuilderArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:image-builder/${parameters.imageBuilderName}`
}
...
export function stackArn(parameters: StackArnParameters): StackArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:stack/${parameters.stackName}`
}
...
export function appBlockArn(parameters: AppBlockArnParameters): AppBlockArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:app-block/${parameters.appBlockName}`
}
...
export function applicationArn(parameters: ApplicationArnParameters): ApplicationArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:application/${parameters.applicationName}`
}
...
export function appBlockBuilderArn(parameters: AppBlockBuilderArnParameters): AppBlockBuilderArn {
  return `arn:${parameters.partition ?? 'aws'}:appstream:${parameters.region}:${parameters.account}:app-block-builder/${parameters.appBlockBuilderName}`
}