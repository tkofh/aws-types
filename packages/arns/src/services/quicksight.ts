...
class AccountArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'account', `arn:${string}:quicksight:${string}:${string}:account/${string}`> {
...
class UserArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'user', `arn:${string}:quicksight:${string}:${string}:user/${string}`> {
...
class GroupArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'group', `arn:${string}:quicksight:${string}:${string}:group/${string}`> {
...
class AnalysisArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'analysis', `arn:${string}:quicksight:${string}:${string}:analysis/${string}`> {
...
export function analysisArn<Partition extends ArnPartition = 'aws'>(parameters: AnalysisArnParameters<Partition>) {
...
class DashboardArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'dashboard', `arn:${string}:quicksight:${string}:${string}:dashboard/${string}`> {
...
class TemplateArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'template', `arn:${string}:quicksight:${string}:${string}:template/${string}`> {
...
class VpcconnectionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'vpcconnection', `arn:${string}:quicksight:${string}:${string}:vpcConnection/${string}`> {
...
export interface AssetBundleExportJobArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly resourceId: string
}
class AssetBundleExportJobArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'assetBundleExportJob', `arn:${string}:quicksight:${string}:${string}:asset-bundle-export-job/${string}`> {
...
export function assetBundleExportJobArn<Partition extends ArnPartition = 'aws'>(parameters: AssetBundleExportJobArnParameters<Partition>) {
  return new AssetBundleExportJobArn<Partition>(parameters)
}

export interface AssetBundleImportJobArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly resourceId: string
}
class AssetBundleImportJobArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'assetBundleImportJob', `arn:${string}:quicksight:${string}:${string}:asset-bundle-import-job/${string}`> {
...
export function assetBundleImportJobArn<Partition extends ArnPartition = 'aws'>(parameters: AssetBundleImportJobArnParameters<Partition>) {
...
class DatasourceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'datasource', `arn:${string}:quicksight:${string}:${string}:datasource/${string}`> {
...
class DatasetArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'dataset', `arn:${string}:quicksight:${string}:${string}:dataset/${string}`> {
...
class IngestionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'ingestion', `arn:${string}:quicksight:${string}:${string}:dataset/${string}/ingestion/${string}`> {
...
export interface RefreshscheduleArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly datasetId: string
...
class RefreshscheduleArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'refreshschedule', `arn:${string}:quicksight:${string}:${string}:dataset/${string}/refresh-schedule/${string}`> {
...
export function refreshscheduleArn<Partition extends ArnPartition = 'aws'>(parameters: RefreshscheduleArnParameters<Partition>) {
...
class ThemeArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'theme', `arn:${string}:quicksight:${string}:${string}:theme/${string}`> {
...
export function themeArn<Partition extends ArnPartition = 'aws'>(parameters: ThemeArnParameters<Partition>) {
  return new ThemeArn<Partition>(parameters)
}

export interface AssignmentArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly account: string
  readonly resourceId: string
}
class AssignmentArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'assignment', `arn:${string}:quicksight::${string}:assignment/${string}`> {
...
export function assignmentArn<Partition extends ArnPartition = 'aws'>(parameters: AssignmentArnParameters<Partition>) {
...
class CustomizationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'customization', `arn:${string}:quicksight:${string}:${string}:customization/${string}`> {
...
class NamespaceArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'namespace', `arn:${string}:quicksight:${string}:${string}:namespace/${string}`> {
...
class FolderArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'folder', `arn:${string}:quicksight:${string}:${string}:folder/${string}`> {
...
export interface EmailCustomizationTemplateArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
  readonly resourceId: string
}
class EmailCustomizationTemplateArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'emailCustomizationTemplate', `arn:${string}:quicksight:${string}:${string}:email-customization-template/${string}`> {
...
export function emailCustomizationTemplateArn<Partition extends ArnPartition = 'aws'>(parameters: EmailCustomizationTemplateArnParameters<Partition>) {
...
class TopicArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'topic', `arn:${string}:quicksight:${string}:${string}:topic/${string}`> {
...
export interface DashboardSnapshotJobArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly account: string
...
class DashboardSnapshotJobArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'dashboardSnapshotJob', `arn:${string}:quicksight:${string}:${string}:dashboard/${string}/snapshot-job/${string}`> {
...
export function dashboardSnapshotJobArn<Partition extends ArnPartition = 'aws'>(parameters: DashboardSnapshotJobArnParameters<Partition>) {
