...
export function datastoreArn(parameters: DatastoreArnParameters): DatastoreArn {
  return `arn:${parameters.partition ?? 'aws'}:medical-imaging:${parameters.region}:${parameters.account}:datastore/${parameters.datastoreId}`
}
...
export function imagesetArn(parameters: ImagesetArnParameters): ImagesetArn {
  return `arn:${parameters.partition ?? 'aws'}:medical-imaging:${parameters.region}:${parameters.account}:datastore/${parameters.datastoreId}/imageset/${parameters.imageSetId}`
}