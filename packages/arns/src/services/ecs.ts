...
export function clusterArn(parameters: ClusterArnParameters): ClusterArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:cluster/${parameters.clusterName}`
}
...
export function containerInstanceArn(parameters: ContainerInstanceArnParameters): ContainerInstanceArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:container-instance/${parameters.clusterName}/${parameters.containerInstanceId}`
}
...
export function serviceArn(parameters: ServiceArnParameters): ServiceArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:service/${parameters.clusterName}/${parameters.serviceName}`
}
...
export function taskArn(parameters: TaskArnParameters): TaskArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:task/${parameters.clusterName}/${parameters.taskId}`
}
...
export function taskDefinitionArn(parameters: TaskDefinitionArnParameters): TaskDefinitionArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:task-definition/${parameters.taskDefinitionFamilyName}:${parameters.taskDefinitionRevisionNumber}`
}
...
export function capacityProviderArn(parameters: CapacityProviderArnParameters): CapacityProviderArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:capacity-provider/${parameters.capacityProviderName}`
}
...
export function taskSetArn(parameters: TaskSetArnParameters): TaskSetArn {
  return `arn:${parameters.partition ?? 'aws'}:ecs:${parameters.region}:${parameters.account}:task-set/${parameters.clusterName}/${parameters.serviceName}/${parameters.taskSetId}`
}