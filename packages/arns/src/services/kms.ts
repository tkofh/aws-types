...
class AliasArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'alias', `arn:${string}:kms:${string}:${string}:alias/${string}`> {
...
class KeyArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'key', `arn:${string}:kms:${string}:${string}:key/${string}`> {
