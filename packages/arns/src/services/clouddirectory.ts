...
export function appliedSchemaArn(parameters: AppliedSchemaArnParameters): AppliedSchemaArn {
  return `arn:${parameters.partition ?? 'aws'}:clouddirectory:${parameters.region}:${parameters.account}:directory/${parameters.directoryId}/schema/${parameters.schemaName}/${parameters.version}`
}
...
export function developmentSchemaArn(parameters: DevelopmentSchemaArnParameters): DevelopmentSchemaArn {
  return `arn:${parameters.partition ?? 'aws'}:clouddirectory:${parameters.region}:${parameters.account}:schema/development/${parameters.schemaName}`
}
...
export function directoryArn(parameters: DirectoryArnParameters): DirectoryArn {
  return `arn:${parameters.partition ?? 'aws'}:clouddirectory:${parameters.region}:${parameters.account}:directory/${parameters.directoryId}`
}
...
export function publishedSchemaArn(parameters: PublishedSchemaArnParameters): PublishedSchemaArn {
  return `arn:${parameters.partition ?? 'aws'}:clouddirectory:${parameters.region}:${parameters.account}:schema/published/${parameters.schemaName}/${parameters.version}`
}