...
export function playbackConfigurationArn(parameters: PlaybackConfigurationArnParameters): PlaybackConfigurationArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:playbackConfiguration/${parameters.resourceId}`
}
...
export function prefetchScheduleArn(parameters: PrefetchScheduleArnParameters): PrefetchScheduleArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:prefetchSchedule/${parameters.resourceId}`
}
...
export function channelArn(parameters: ChannelArnParameters): ChannelArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:channel/${parameters.channelName}`
}
...
export function programArn(parameters: ProgramArnParameters): ProgramArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:program/${parameters.channelName}/${parameters.programName}`
}
...
export function sourceLocationArn(parameters: SourceLocationArnParameters): SourceLocationArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:sourceLocation/${parameters.sourceLocationName}`
}
...
export function vodSourceArn(parameters: VodSourceArnParameters): VodSourceArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:vodSource/${parameters.sourceLocationName}/${parameters.vodSourceName}`
}
...
export function liveSourceArn(parameters: LiveSourceArnParameters): LiveSourceArn {
  return `arn:${parameters.partition ?? 'aws'}:mediatailor:${parameters.region}:${parameters.account}:liveSource/${parameters.sourceLocationName}/${parameters.liveSourceName}`
}