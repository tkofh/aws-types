...
export function bytematchsetArn(parameters: BytematchsetArnParameters): BytematchsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:bytematchset/${parameters.id}`
}
...
export function ipsetArn(parameters: IpsetArnParameters): IpsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:ipset/${parameters.id}`
}
...
export function ratebasedruleArn(parameters: RatebasedruleArnParameters): RatebasedruleArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:ratebasedrule/${parameters.id}`
}
...
export function ruleArn(parameters: RuleArnParameters): RuleArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:rule/${parameters.id}`
}
...
export function sizeconstraintsetArn(parameters: SizeconstraintsetArnParameters): SizeconstraintsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:sizeconstraintset/${parameters.id}`
}
...
export function sqlinjectionmatchsetArn(parameters: SqlinjectionmatchsetArnParameters): SqlinjectionmatchsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:sqlinjectionset/${parameters.id}`
}
...
export function webaclArn(parameters: WebaclArnParameters): WebaclArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:webacl/${parameters.id}`
}
...
export function xssmatchsetArn(parameters: XssmatchsetArnParameters): XssmatchsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:xssmatchset/${parameters.id}`
}
...
export function regexmatchsetArn(parameters: RegexmatchsetArnParameters): RegexmatchsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:regexmatch/${parameters.id}`
}
...
export function regexpatternsetArn(parameters: RegexpatternsetArnParameters): RegexpatternsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:regexpatternset/${parameters.id}`
}
...
export function geomatchsetArn(parameters: GeomatchsetArnParameters): GeomatchsetArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:geomatchset/${parameters.id}`
}
...
export function rulegroupArn(parameters: RulegroupArnParameters): RulegroupArn {
  return `arn:${parameters.partition ?? 'aws'}:waf-regional:${parameters.region}:${parameters.account}:rulegroup/${parameters.id}`
}