...
export function namespaceArn(parameters: NamespaceArnParameters): NamespaceArn {
  return `arn:${parameters.partition ?? 'aws'}:servicediscovery:${parameters.region}:${parameters.account}:namespace/${parameters.namespaceId}`
}
...
export function serviceArn(parameters: ServiceArnParameters): ServiceArn {
  return `arn:${parameters.partition ?? 'aws'}:servicediscovery:${parameters.region}:${parameters.account}:service/${parameters.serviceId}`
}