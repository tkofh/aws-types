...
export function trainingdatasetArn(parameters: TrainingdatasetArnParameters): TrainingdatasetArn {
  return `arn:${parameters.partition ?? 'aws'}:cleanrooms-ml:${parameters.region}:${parameters.account}:training-dataset/${parameters.resourceId}`
}
...
export function audiencemodelArn(parameters: AudiencemodelArnParameters): AudiencemodelArn {
  return `arn:${parameters.partition ?? 'aws'}:cleanrooms-ml:${parameters.region}:${parameters.account}:audience-model/${parameters.resourceId}`
}
...
export function configuredaudiencemodelArn(parameters: ConfiguredaudiencemodelArnParameters): ConfiguredaudiencemodelArn {
  return `arn:${parameters.partition ?? 'aws'}:cleanrooms-ml:${parameters.region}:${parameters.account}:configured-audience-model/${parameters.resourceId}`
}
...
export function audiencegenerationjobArn(parameters: AudiencegenerationjobArnParameters): AudiencegenerationjobArn {
  return `arn:${parameters.partition ?? 'aws'}:cleanrooms-ml:${parameters.region}:${parameters.account}:audience-generation-job/${parameters.resourceId}`
}