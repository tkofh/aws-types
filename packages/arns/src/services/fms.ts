...
export function policyArn(parameters: PolicyArnParameters): PolicyArn {
  return `arn:${parameters.partition ?? 'aws'}:fms:${parameters.region}:${parameters.account}:policy/${parameters.id}`
}
...
export function applicationsListArn(parameters: ApplicationsListArnParameters): ApplicationsListArn {
  return `arn:${parameters.partition ?? 'aws'}:fms:${parameters.region}:${parameters.account}:applications-list/${parameters.id}`
}
...
export function protocolsListArn(parameters: ProtocolsListArnParameters): ProtocolsListArn {
  return `arn:${parameters.partition ?? 'aws'}:fms:${parameters.region}:${parameters.account}:protocols-list/${parameters.id}`
}
...
export function resourceSetArn(parameters: ResourceSetArnParameters): ResourceSetArn {
  return `arn:${parameters.partition ?? 'aws'}:fms:${parameters.region}:${parameters.account}:resource-set/${parameters.id}`
}