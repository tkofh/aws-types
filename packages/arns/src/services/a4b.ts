...
export function profileArn(parameters: ProfileArnParameters): ProfileArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:profile/${parameters.resourceId}`
}
...
export function roomArn(parameters: RoomArnParameters): RoomArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:room/${parameters.resourceId}`
}
...
export function deviceArn(parameters: DeviceArnParameters): DeviceArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:device/${parameters.resourceId}`
}
...
export function skillgroupArn(parameters: SkillgroupArnParameters): SkillgroupArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:skill-group/${parameters.resourceId}`
}
...
export function userArn(parameters: UserArnParameters): UserArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:user/${parameters.resourceId}`
}
...
export function addressbookArn(parameters: AddressbookArnParameters): AddressbookArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:address-book/${parameters.resourceId}`
}
...
export function conferenceproviderArn(parameters: ConferenceproviderArnParameters): ConferenceproviderArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:conference-provider/${parameters.resourceId}`
}
...
export function contactArn(parameters: ContactArnParameters): ContactArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:contact/${parameters.resourceId}`
}
...
export function scheduleArn(parameters: ScheduleArnParameters): ScheduleArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:schedule/${parameters.resourceId}`
}
...
export function networkprofileArn(parameters: NetworkprofileArnParameters): NetworkprofileArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:network-profile/${parameters.resourceId}`
}
...
export function gatewayArn(parameters: GatewayArnParameters): GatewayArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:gateway/${parameters.resourceId}`
}
...
export function gatewaygroupArn(parameters: GatewaygroupArnParameters): GatewaygroupArn {
  return `arn:${parameters.partition ?? 'aws'}:a4b:${parameters.region}:${parameters.account}:gateway-group/${parameters.resourceId}`
}