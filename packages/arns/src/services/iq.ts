...
export interface ConversationArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly conversationId: string
}
class ConversationArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'conversation', `arn:${string}:iq:${string}::conversation/${string}`> {
...
export function conversationArn<Partition extends ArnPartition = 'aws'>(parameters: ConversationArnParameters<Partition>) {
...
class BuyerArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'buyer', `arn:${string}:iq:${string}::buyer/${string}`> {
...
export function buyerArn<Partition extends ArnPartition = 'aws'>(parameters: BuyerArnParameters<Partition>) {
...
class ExpertArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'expert', `arn:${string}:iq:${string}::expert/${string}`> {
...
export function expertArn<Partition extends ArnPartition = 'aws'>(parameters: ExpertArnParameters<Partition>) {
...
class CallArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'call', `arn:${string}:iq:${string}::call/${string}`> {
...
export type { CallArn }
export function callArn<Partition extends ArnPartition = 'aws'>(parameters: CallArnParameters<Partition>) {
...
class TokenArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'token', `arn:${string}:iq:${string}::token/${string}`> {
...
class ProposalArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'proposal', `arn:${string}:iq:${string}::proposal/${string}/${string}`> {
...
export interface PaymentRequestArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly conversationId: string
  readonly proposalId: string
...
class PaymentRequestArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'paymentRequest', `arn:${string}:iq:${string}::paymentRequest/${string}/${string}/${string}`> {
...
export function paymentRequestArn<Partition extends ArnPartition = 'aws'>(parameters: PaymentRequestArnParameters<Partition>) {
  return new PaymentRequestArn<Partition>(parameters)
}

export interface PaymentScheduleArnParameters<Partition extends ArnPartition = 'aws'> {
  readonly partition?: Partition | undefined
  readonly region: ArnRegion<Partition>
  readonly conversationId: string
  readonly proposalId: string
...
class PaymentScheduleArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'paymentSchedule', `arn:${string}:iq:${string}::paymentSchedule/${string}/${string}/${string}`> {
...
export function paymentScheduleArn<Partition extends ArnPartition = 'aws'>(parameters: PaymentScheduleArnParameters<Partition>) {
...
class SellerArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'seller', `arn:${string}:iq:${string}::seller/${string}`> {
...
export function sellerArn<Partition extends ArnPartition = 'aws'>(parameters: SellerArnParameters<Partition>) {
...
class CompanyArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'company', `arn:${string}:iq:${string}::company/${string}`> {
...
export function companyArn<Partition extends ArnPartition = 'aws'>(parameters: CompanyArnParameters<Partition>) {
...
class RequestArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'request', `arn:${string}:iq:${string}::request/${string}`> {
...
export function requestArn<Partition extends ArnPartition = 'aws'>(parameters: RequestArnParameters<Partition>) {
...
class ListingArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'listing', `arn:${string}:iq:${string}::listing/${string}`> {
...
export function listingArn<Partition extends ArnPartition = 'aws'>(parameters: ListingArnParameters<Partition>) {
...
class AttachmentArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'attachment', `arn:${string}:iq:${string}::attachment/${string}`> {
