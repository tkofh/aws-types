...
export function channelArn(parameters: ChannelArnParameters): ChannelArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:channel/${parameters.resourceId}`
}
...
export function streamKeyArn(parameters: StreamKeyArnParameters): StreamKeyArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:stream-key/${parameters.resourceId}`
}
...
export function playbackKeyPairArn(parameters: PlaybackKeyPairArnParameters): PlaybackKeyPairArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:playback-key/${parameters.resourceId}`
}
...
export function playbackRestrictionPolicyArn(parameters: PlaybackRestrictionPolicyArnParameters): PlaybackRestrictionPolicyArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:playback-restriction-policy/${parameters.resourceId}`
}
...
export function recordingConfigurationArn(parameters: RecordingConfigurationArnParameters): RecordingConfigurationArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:recording-configuration/${parameters.resourceId}`
}
...
export function stageArn(parameters: StageArnParameters): StageArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:stage/${parameters.resourceId}`
}
...
export function compositionArn(parameters: CompositionArnParameters): CompositionArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:composition/${parameters.resourceId}`
}
...
export function encoderConfigurationArn(parameters: EncoderConfigurationArnParameters): EncoderConfigurationArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:encoder-configuration/${parameters.resourceId}`
}
...
export function storageConfigurationArn(parameters: StorageConfigurationArnParameters): StorageConfigurationArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:storage-configuration/${parameters.resourceId}`
}
...
export function publicKeyArn(parameters: PublicKeyArnParameters): PublicKeyArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:public-key/${parameters.resourceId}`
}
...
export function ingestConfigurationArn(parameters: IngestConfigurationArnParameters): IngestConfigurationArn {
  return `arn:${parameters.partition ?? 'aws'}:ivs:${parameters.region}:${parameters.account}:ingest-configuration/${parameters.resourceId}`
}