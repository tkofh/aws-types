...
class ConnectionArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'Connection', `arn:${string}:codestar-connections:${string}:${string}:connection/${string}`> {
...
class HostArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'Host', `arn:${string}:codestar-connections:${string}:${string}:host/${string}`> {
...
class RepositoryLinkArn<Partition extends ArnPartition = 'aws'> extends InternalArn<'RepositoryLink', `arn:${string}:codestar-connections:${string}:${string}:repository-link/${string}`> {
