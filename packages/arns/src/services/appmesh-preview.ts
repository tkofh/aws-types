...
export function meshArn(parameters: MeshArnParameters): MeshArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}`
}
...
export function virtualServiceArn(parameters: VirtualServiceArnParameters): VirtualServiceArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}/virtualService/${parameters.virtualServiceName}`
}
...
export function virtualNodeArn(parameters: VirtualNodeArnParameters): VirtualNodeArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}/virtualNode/${parameters.virtualNodeName}`
}
...
export function virtualRouterArn(parameters: VirtualRouterArnParameters): VirtualRouterArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}/virtualRouter/${parameters.virtualRouterName}`
}
...
export function routeArn(parameters: RouteArnParameters): RouteArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}/virtualRouter/${parameters.virtualRouterName}/route/${parameters.routeName}`
}
...
export function virtualGatewayArn(parameters: VirtualGatewayArnParameters): VirtualGatewayArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}/virtualGateway/${parameters.virtualGatewayName}`
}
...
export function gatewayRouteArn(parameters: GatewayRouteArnParameters): GatewayRouteArn {
  return `arn:${parameters.partition ?? 'aws'}:appmesh-preview:${parameters.region}:${parameters.account}:mesh/${parameters.meshName}/virtualGateway/${parameters.virtualGatewayName}/gatewayRoute/${parameters.gatewayRouteName}`
}