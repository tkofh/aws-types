...
export type ArnRegion<Partition extends ArnPartition = 'aws'> =
  Partition extends 'aws'
    ?
        | 'us-east-1'
        | 'us-east-2'
        | 'us-west-1'
    ...
    : Partition extends 'aws-cn'
      ?
          ...
          | 'cn-southwest-1'
          | 'cn-south-1'
      : Partition extends 'aws-us-gov'
        ? 'us-gov-east-1' | 'us-gov-west-1'
        : never

export const StringifyArnBrand: unique symbol = Symbol.for(
  '@aws-types/arns/~/StringifyArn',
)
export type StringifyArnBrand = typeof StringifyArnBrand

export const ArnResourceTypeBrand: unique symbol = Symbol.for(
  '@aws-types/arns/~/ArnResourceType',
)
...
export abstract class InternalArn<T extends string, P extends string>
  implements Arn<T, P>
{
